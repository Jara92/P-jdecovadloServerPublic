...
public class PickupProtocolOwnerAuthorizationHandlerTest
{
    PickupProtocolOwnerAuthorizationHandler _authorizationHandler;
    ...
    public void Setup()
    {
        ...
        _authorizationHandler = new PickupProtocolOwnerAuthorizationHandler(_authenticateService.Object);
    ...
    {
        _pickupProtocol.Loan.Item.Owner = new ApplicationUser { Id = "20" };
        ...
        // act
        var context =
            new AuthorizationHandlerContext(new List<IAuthorizationRequirement> { PickupProtocolOperations.Read },
                _owner,
                _pickupProtocol);
        await _authorizationHandler.HandleAsync(context);
    ...
    {
        _pickupProtocol.Loan.Item.Owner = new ApplicationUser { Id = _ownerId };
    ...
    public async Task Update_UserHasOwnerRoleButIsNotTheOwner_ReturnsFalse()
    {
        ...
        // act
        var context =
            new AuthorizationHandlerContext(new List<IAuthorizationRequirement> { PickupProtocolOperations.Update },
                _owner,
                _pickupProtocol);
        await _authorizationHandler.HandleAsync(context);
    ...
    public async Task Delete_UserHasOwnerRoleButIsNotTheOwner_ReturnsFalse()
    {
        ...
        // act
        var context =
            new AuthorizationHandlerContext(new List<IAuthorizationRequirement> { PickupProtocolOperations.Delete },
                _owner,
                _pickupProtocol);
        await _authorizationHandler.HandleAsync(context);
