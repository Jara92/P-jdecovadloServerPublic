...
public class PickupProtocolTenantAuthorizationHandlerTest
{
    PickupProtocolTenantAuthorizationHandler _authorizationHandler;
    ...
    public void Setup()
    {
        ...
        _authorizationHandler = new PickupProtocolTenantAuthorizationHandler(_authenticateService.Object);
    ...
    {
        _pickupProtocol.Loan.Tenant = new ApplicationUser { Id = "20" };
    ...
    {
        _pickupProtocol.Loan.Tenant = new ApplicationUser { Id = _tenantId };
